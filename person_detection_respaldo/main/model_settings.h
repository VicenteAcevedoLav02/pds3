...
constexpr int kAbiertaIndex = 0;
constexpr int kCerradoIndex = 1;
constexpr int kPulgarIndex = 2;
constexpr int kRockIndex = 3;
constexpr int kTresDedosIndex = 4;
constexpr int kUnDedoIndex = 5;
